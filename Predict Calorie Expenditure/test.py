...
sample = {'Age':36,'Height':186.0,'Weight':82,'Duration':26.0,'Heart_Rate':101.0,'Body_Temp':41.0,'Sex':1}

sample_df = pd.DataFrame(sample, index = [1])

processed = feature_engineering(sample_df)

pred = model.predict(processed)

print(f"Calories Expended: {np.expm1(pred)}")